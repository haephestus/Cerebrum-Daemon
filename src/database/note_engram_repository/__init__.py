...
Merged replacement for the old pair of:
  - database.note_registry.NoteRegisterInator
...
signature here, so existing call sites only need to change the import:
    ...
    - from database.note_registry_inator import NoteRegisterInator
...
from cerebrum_core.engrams.core.mastery_service import MasteryRepository
...
from .learning_profile import LearningProfileMixin
